...
using UnityEngine;
using Joint2D = FarseerPhysics.Dynamics.Joints.Joint2D;
...
public static class FarseerGizmos
{
	...
	public static void DrawShape(Fixture fixture, Transform2D xf, Color color)
	{
		...
		case ShapeType.Polygon:
		{
			...
			{
				Debug.LogError(string.Format("BREAK: Vertex count of object too high. Verts: {0}, Max: {1}", count2, Settings.MaxPolygonVertices));
				Debug.Break();
				break;
			}
